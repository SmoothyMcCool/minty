...
public class FormatCustomHtml implements MintyTask, ServiceConsumer {
	...
	public FormatCustomHtml(FormatCustomHtmlConfig config) {
		this();
		this.config = config;
	}
	...
	public TaskSpec getSpecification() {
		return new TaskSpec() {
			...
			public TaskConfigSpec taskConfiguration() {
				return new FormatCustomHtmlConfig();
			}

			@Override
			public TaskConfigSpec taskConfiguration(Map<String, Object> configuration) {
				return new FormatCustomHtmlConfig(configuration);
			}

			@Override
			public String taskName() {
				return "Format Custom Html";
			}
