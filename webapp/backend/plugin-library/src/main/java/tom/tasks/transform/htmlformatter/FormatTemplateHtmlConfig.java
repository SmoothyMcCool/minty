...
public class FormatTemplateHtmlConfig implements TaskConfigSpec {

	private String template;

	public FormatTemplateHtmlConfig() {
		template = "";
	}

	public FormatTemplateHtmlConfig(Map<String, Object> config) {
		this();
