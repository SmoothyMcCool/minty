...
public class RenderServiceImpl implements RenderService {
	...
	@Override
	public Path renderPug(String template, String outfileName, Map<String, Object> data) throws IOException {
	...
	@Override
	public Path renderJson(String outfileName, Map<String, Object> data) throws IOException {
		Path location = Path.of(resultsDir + "/" + outfileName);
