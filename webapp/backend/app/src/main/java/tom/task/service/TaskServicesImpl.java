...
public class TaskServicesImpl implements TaskServices {
	...
	private final PugRenderService pugRenderService;
	...
	public TaskServicesImpl(AssistantService assistantService, ConversationService conversationService,
			...
			PugRenderService pugRenderService) {
		this.assistantService = assistantService;
		this.conversationService = conversationService;
		this.documentService = documentService;
		this.httpService = httpService;
		this.pythonService = pythonService;
		this.pugRenderService = pugRenderService;
	}
	...
	@Override
	public PugRenderService getPugRenderService() {
		return pugRenderService;
	}
