...
public class PdfExtractor {
    ...
    /**
     * Cleans up raw Tika output:
     * - strips TOC dot leader lines
     * - removes very short lines (page numbers, stray labels)
     * - removes lines that are pure paths/URIs with no prose
