...
public class HttpServiceImpl implements HttpService {
	...
	@Override
	public <ResponseType> ResponseType getBasicAuth(int userId, String url, Map<String, String> parameters, ResponseType dummy) {
	...
	@Override
	public <ResponseType> ResponseType getJavaEEFormAuth(int userId, String url, Map<String, String> parameters, ResponseType dummy) {
