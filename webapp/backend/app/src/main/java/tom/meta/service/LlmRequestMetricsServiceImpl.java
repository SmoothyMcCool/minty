...
public class LlmRequestMetricsServiceImpl implements LlmRequestMetricsService {

	private static final Logger logger = LogManager.getLogger(LlmRequestMetricsServiceImpl.class);
	...
	public LlmRequestMetricsServiceImpl(AiRequestRepository requestRepository,
