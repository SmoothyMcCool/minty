package tom.document.service.extract.pandoc;
...
public class PandocConverter {
	...
	public PandocConverter(String pandocPath, String outputFormat, String luaFilter, boolean noHighlight,
			boolean stripComments, String wrap, int headingLevel, List<String> extraArgs) {
	 ...
	 * --from=<inputFormat> is added to the command (e.g. "html" when converting
	 * Tika HTML output).
	 */
