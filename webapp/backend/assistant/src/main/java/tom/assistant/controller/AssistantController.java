...
public class AssistantController {
	...
	public AssistantController(AssistantManagementServiceInternal assistantManagementService,
			AssistantQueryService assistantQueryService, AnalyticsService analyticsService,
			MetadataService metadataService, LlmClientRegistry llmClientRegistry,
	...
	public ResponseEntity<ResponseWrapper<Assistant>> addAssistant(@AuthenticationPrincipal UserDetailsUser user,
		...
		analyticsService.recordAssistantCreated(user.getId(), newAssistant.id());
	...
	public ResponseEntity<ResponseWrapper<ConversationId>> ask(@AuthenticationPrincipal UserDetailsUser user,
		...
		if (conversationService.conversationOwnedBy(user.getId(), cId)) {
			...
			analyticsService.recordMessage(user.getId(), cId);
